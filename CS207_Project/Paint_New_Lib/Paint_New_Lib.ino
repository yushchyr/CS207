...
void drawBackButton() {
  extern const uint8_t BackButton40x40[1600];
  pos_X = 0;
  pos_Y = tft.height() - 40;
  tft.setAddrWindow(pos_X, pos_Y, pos_X + 39, pos_Y + 40);
  tft.pushColors(BackButton40x40, 1600, 1);
}

void drawEraseButton(){
  extern const uint8_t EraseButton[1600];
  pos_X = tft.width() - 40;
  pos_Y = tft.height() - 40;
  tft.setAddrWindow(pos_X, pos_Y, pos_X + 39, pos_Y + 40);
  tft.pushColors(EraseButton, 1600, 1);
}
